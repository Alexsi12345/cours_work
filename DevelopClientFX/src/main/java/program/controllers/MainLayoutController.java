...
public class MainLayoutController {
    ...
    /**
     * Открытие сцены контактов
     */
    @FXML
    public void openContactScene() {
        main.showContactScene();
    }

    /**
     * Открытие сцены о компании
     */
    @FXML
    public void openAboutCompanyScene() {
        main.showAboutCompanyScene();
    }

    /**
     * Открытие сцены проектов
     */
    @FXML
    public void openProjectInfo() {
        main.showProjectInfoScene();
    }
